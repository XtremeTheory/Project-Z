...
captureIP('dashboard-sales.php');
verifyAdmin("2","dashboard-sales.php"); ?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Sales Dashboard - Project Z</title>
  ...
  <link rel="stylesheet" type="text/css" href="js/vendors/css/charts/jquery-jvectormap-2.0.3.css">
  <link rel="stylesheet" type="text/css" href="js/vendors/css/charts/morris.css">
...
<body class="vertical-layout vertical-overlay-menu 2-columns menu-expanded fixed-navbar" data-open="click" data-menu="vertical-overlay-menu" data-col="2-columns">
  ...
  <script src="js/vendors/js/charts/chart.min.js" type="text/javascript"></script>
  ...
  <script src="js/vendors/js/charts/jvector/jquery-jvectormap-2.0.3.min.js" type="text/javascript"></script>
  <script src="js/vendors/js/charts/jvector/jquery-jvectormap-world-mill.js" type="text/javascript"></script>
