<?php
captureIP('district-list.php');
verifyAdmin("2","district-list.php");
$uid = $_SESSION['uid'];?>
<!DOCTYPE html>
...
<head>
  ...
  <title>District List - Pro Dasher</title>
    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title mb-0">District List</h3>
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    <p class="card-text">Every district is listed here.</p>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h3 class="modal-title" id="addStore"> Add District</h3>
