...
?>
  ...
  <div class="row">
    <div class="form-group col-sm-5">
      ...
      <input type="text" disabled class="form-control required" id="city" placeholder="City" value="<?php echo ucfirst(strtolower($cityinfo['city'])); ?>">
    </div>
    <div class="form-group col-sm-3">
      <label for="state">State</label>
      <input type="text" disabled class="form-control required" id="state" placeholder="State" value="<?php echo $cityinfo['state']; ?>">
    </div>
  ...
  <fieldset class="form-group floating-label-form-group">
    ...
    <input type="text" disabled class="form-control required" id="county" placeholder="County" value="<?php echo ucfirst(strtolower($cityinfo['county'])); ?>">
  </fieldset>
  <br>
  <div class="row">
    <div class="form-group col-sm-4">
