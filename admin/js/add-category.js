...
document.getElementById("but-addCategory").style.display = "block";
...
$(document).off('click', '#but-addCategory').on('click', '#but-addCategory', function () {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        if(data == "correct") {
          ...
          swal("Success!", "Another category has been added to the database, sweet!", "success");
