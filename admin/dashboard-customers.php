...
<head>
  ...
  <title>Customer's Dashboard - Project Z</title>
  ...
  <link rel="stylesheet" type="text/css" href="js/vendors/css/weather-icons/climacons.min.css">
  <link rel="stylesheet" type="text/css" href="app-assets/fonts/meteocons/style.css">
  <link rel="stylesheet" type="text/css" href="js/vendors/css/charts/morris.css">
  <link rel="stylesheet" type="text/css" href="js/vendors/css/charts/chartist.css">
  <link rel="stylesheet" type="text/css" href="js/vendors/css/charts/chartist-plugin-tooltip.css">
  <!-- END VENDOR CSS-->
  <!-- BEGIN MODERN CSS-->
...
<body class="vertical-layout vertical-overlay-menu 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-overlay-menu" data-col="2-columns">
  ...
  <script src="js/vendors/js/charts/chartist.min.js" type="text/javascript"></script>
  <script src="js/vendors/js/charts/chartist-plugin-tooltip.min.js" type="text/javascript"></script>
