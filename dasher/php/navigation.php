      ...
      <ul class="nav navbar-nav flex-row">
        ...
        <li class="nav-item">
          <a class="navbar-brand" href="/">
            <img alt="Pro Dasher Logo" src="app-assets/images/logo/logo.png" width="190" height="40">
          </a>
        </li>
            ...
            <ul class="mega-dropdown-menu dropdown-menu row">
              <li class="col-md-2">
                ...
                <div id="mega-menu-carousel-example">
                  <div>
                    <img class="rounded img-fluid mb-1" src="assets/img/slider-2.png"
                ...
                <ul class="drilldown-menu">
                  <li class="menu-list">
                    <ul>
                      ...
                      <li><a class="dropdown-item" href="change-log.php"><i class="ft-minimize-2"></i> Change log</a></li>
                      <li>
          ...
          <li class="dropdown dropdown-user nav-item">
            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
              ...
              <span class="avatar avatar-online">
                <img src="assets/img/profile/avatar-s-19.png" alt="avatar"><i></i></span>
            </a>
              ...
              <li class="scrollable-container media-list w-100">
                  ...
                  <div class="media">
                    <div class="media-left">
                      <span class="avatar avatar-sm avatar-busy rounded-circle">
                        <img src="assets/img/profile/avatar-s-2.png" alt="avatar"><i></i></span>
                    </div>
                    <div class="media-body">
                ...
                <a href="javascript:void(0)">
                  <div class="media">
                    <div class="media-left">
                      <span class="avatar avatar-sm avatar-online rounded-circle">
                        <img src="assets/img/profile/avatar-s-3.png" alt="avatar"><i></i></span>
                    </div>
                    <div class="media-body">
                  ...
                  <div class="media">
                    <div class="media-left">
                      <span class="avatar avatar-sm avatar-away rounded-circle">
                        <img src="assets/img/profile/avatar-s-6.png" alt="avatar"><i></i></span>
                    </div>
                    <div class="media-body">
